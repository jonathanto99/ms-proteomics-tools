...
if command -v node &> /dev/null; then
    ...
    echo "⚠️  Node.js not found. Web app frontend will not be available."
...
echo "  2. Run data analysis: python programs/python/MSPP_data_analysis.ipynb"
echo "  3. Run web app:"
echo "     Terminal 1: python programs/mspp_web/backend/app.py"
echo "     Terminal 2: cd programs/mspp_web/frontend && npm run dev"
echo ""
